...
void CDlg_CFOAT00100::InitCtrls()
{
	...
	InsertColumn4List( this, IDC_OUTBLOCK1, nCol++, "선물옵션거래유형코드", TRUE ,    2 );    // [string,    2] 선물옵션거래유형코드
	...
	InsertColumn4List( this, IDC_OUTBLOCK1, nCol++, "항목번호            ", FALSE,   16 );    // [long  ,   16] 항목번호            
	InsertColumn4List( this, IDC_OUTBLOCK1, nCol++, "운용지시번호        ", TRUE ,   12 );    // [string,   12] 운용지시번호        
...
// 데이터 조회
//--------------------------------------------------------------------------------------
void CDlg_CFOAT00100::RequestData( BOOL bNext )
{
	//-----------------------------------------------------------
// 현물정상주문(CFOAT00100) ( base21=SONAT000,headtype=B )
...
// 데이터를 받음
//--------------------------------------------------------------------------------------
LRESULT CDlg_CFOAT00100::OnXMReceiveData( WPARAM wParam, LPARAM lParam )
{
	//-------------------------------------------------------------------------------------
	// Data를 받음
	if( wParam == REQUEST_DATA )
	{
		...
		m_ctrlOutBlock1.SetItemText(  0, nCol++, GetDispData( pAllOutBlock->outBlock1.FnoTrdPtnCode    , sizeof( pAllOutBlock->outBlock1.FnoTrdPtnCode     ), DATA_TYPE_STRING ) );    // [string,    2] 선물옵션거래유형코드
		...
		m_ctrlOutBlock1.SetItemText(  0, nCol++, GetDispData( pAllOutBlock->outBlock1.ItemNo           , sizeof( pAllOutBlock->outBlock1.ItemNo            ), DATA_TYPE_LONG   ) );    // [long  ,   16] 항목번호            
		m_ctrlOutBlock1.SetItemText(  0, nCol++, GetDispData( pAllOutBlock->outBlock1.OpDrtnNo         , sizeof( pAllOutBlock->outBlock1.OpDrtnNo          ), DATA_TYPE_STRING ) );    // [string,   12] 운용지시번호        
...
// Timeout 발생
//--------------------------------------------------------------------------------------
LRESULT CDlg_CFOAT00100::OnXMTimeoutData( WPARAM wParam, LPARAM lParam )
{
	g_iXingAPI.ReleaseRequestData( (int)lParam );
